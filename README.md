...
The current public registry contains **229 native detectors**, including **181 stable secret-format detectors**, with 223 line detectors and 6 contextual detectors. The stable secret set is source-backed and excludes provisional candidates from the stable count. The golden corpus covers all 229 native detectors with deterministic parity.
