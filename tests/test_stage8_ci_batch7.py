...
class Stage8CICDBatch7Tests(unittest.TestCase):
    workflow = ".github/workflows/ci.yml"

    CASES = (
        ("CRT-CI-038", "run: echo ${{ github.event.release.body }}"),
        ("CRT-CI-039", "run: echo ${{ github.event.release.name }}"),
        ("CRT-CI-040", "run: echo ${{ github.event.pages[0].page_name }}"),
        ("CRT-CI-041", "run: echo ${{ github.event.repository.default_branch }}"),
    )
    ...
    def test_documented_untrusted_context_fixtures(self):
