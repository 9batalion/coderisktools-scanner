...
class Stage8CICDBatch4Tests(unittest.TestCase):
    workflow = ".github/workflows/ci.yml"

    CASES = (
        ("CRT-CI-025", "run: echo ${{ github.event.comment.body }}"),
        ("CRT-CI-026", "run: echo ${{ github.event.review.body }}"),
        ("CRT-CI-027", "run: echo ${{ github.event.pull_request_review_comment.body }}"),
        ("CRT-CI-028", "run: echo ${{ github.event.discussion.body }}"),
        ("CRT-CI-029", "run: echo ${{ github.event.pull_request.head.label }}"),
    )
