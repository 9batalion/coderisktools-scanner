...
The current public registry contains **267 native detectors**, including **187 stable secret-format detectors**, with 254 line detectors and 13 contextual detectors. The stable secret set is source-backed and excludes provisional candidates from the stable count. The golden corpus covers all 267 native detectors with deterministic parity.
