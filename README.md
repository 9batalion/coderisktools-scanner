...
The current public registry contains **240 native detectors**, including **187 stable secret-format detectors**, with 233 line detectors and 7 contextual detectors. The stable secret set is source-backed and excludes provisional candidates from the stable count. The golden corpus covers all 240 native detectors with deterministic parity.
