...
The current public registry contains **245 native detectors**, including **187 stable secret-format detectors**, with 236 line detectors and 9 contextual detectors. The stable secret set is source-backed and excludes provisional candidates from the stable count. The golden corpus covers all 245 native detectors with deterministic parity.
